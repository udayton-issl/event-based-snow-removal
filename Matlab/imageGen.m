function img = imageGen(ev, modes, bgColor, options)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FUNCTION: imageGen -- Generate results images                           %
% ----------------------------------------------------------------------- %
% Parameters:                                                             %
%   ev : struct(fields=x, y, ts, p, s), positional required               %
%       Events to create an image from.                                   %
...
% ----------------------------------------------------------------------- %
% imageGen(ev, modes)                                                     %
% imageGen(ev, modes, bgColor)                                            %
% imageGen(ev, modes, camRes=[640,480])                                   %
% imageGen(ev, modes, padding=5)                                          %
% imageGen(ev, modes, camRes=[640,480], padding=5)                        %
% imageGen(ev, modes, bgColor, camRes=[640,480], padding=5)               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
arguments
    ev (1, 1) struct {mustHaveFieldsXYTsPS(ev)}
    modes (1, :) double
